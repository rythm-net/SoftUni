...
public class CarSalesmanV1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberEngine; i++) {
            ...
            CarSalesman.Engine singleEngine = new CarSalesman.Engine(model, power, displacement, efficiency);
        ...
        for (int i = 0; i < numberCars; i++) {
            ...
            CarSalesman.Engine engineForThisCar = new CarSalesman.Engine(engineModel, enginePower, engineDisplacement, engineEfficiency);
