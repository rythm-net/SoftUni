...
namespace _07._Vehicle_Catalogue
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Car> orderedCars = catalongVehicle.CollectionOfCars.OrderBy(x => x.Brand).ToList();
            List<Truck> orderedTrucks = catalongVehicle.CollectionOfTrucks.OrderBy(truck => truck.Brand).ToList();
