...
public class TheMatrix {
    public static void main(String[] args) throws IOException {
        ...
        int[] dimensions = Arrays.stream(rd.readLine().split("\\s+")).mapToInt(Integer::parseInt).toArray();
        ...
        int[] coordinates = Arrays.stream(rd.readLine().split("\\s+")).mapToInt(Integer::parseInt).toArray();
        rd.close();
